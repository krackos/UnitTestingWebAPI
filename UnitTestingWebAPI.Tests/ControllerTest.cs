...
namespace UnitTestingWebAPI.Tests
{
    ...
    public class ControllerTests
    {
        ...
        public void Setup()
        {
            ...
            _articleRepository = SetupArticleRespository();
        ...
        public IArticleRepository SetupArticleRespository()
        {
            ...
            repo.Setup(r => r.GetById(It.IsAny<int>()))
              .Returns(new Func<int, Article>(id => _randomArticles.Find(a => a.ID.Equals(id))));
            ...
            repo.Setup(r => r.Update(It.IsAny<Article>()))
              .Callback(new Action<Article>(x => {
                ...
                oldArticle.DateCreated = DateTime.Now;
        ...
        public void ControlerShouldPutUpdateFirstArticle() {
            var _articleController = new ArticlesController(_articleService)
            {
                Configuration = new HttpConfiguration(),
                Request = new HttpRequestMessage
                {
            ...
            IHttpActionResult updateResult = _articleController.PutArticle(1, new Article(){
                ID = 1,
                Title = "ASP.NET Web API FEAR. oDATA",
        ...
        public void ControllerShouldNotPostNewArticle()
        {
            ...
            var _articlesController = new ArticlesController(_articleService) {
                ...
                Request = new HttpRequestMessage {
                    Method = HttpMethod.Post,
                    RequestUri = new Uri("http://localhot/api/articles")
                }
            };
            _articlesController.Configuration.MapHttpAttributeRoutes();
            _articlesController.Configuration.EnsureInitialized();
